    ...
    stage('Run Docker Image'){
            ...
            withCredentials([string(credentialsId: 'deploymentserverpwd', variable: 'dpPWD')]) {
                  ...
                  sh "sudo sshpass -p ${dpPWD} ssh -o StrictHostKeyChecking=no -T ubuntu@34.101.126.233" 
                  sh "sudo sshpass -p ${dpPWD} scp -r stopscript.sh ubuntu@34.101.126.233:/home/ajeeth_prabhu" 
